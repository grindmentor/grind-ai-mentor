-- Update subscribers table to support simplified Premium subscription system
-- Remove basic tier logic and simplify to just Premium
...
-- Add indexes for better performance on subscription checks
CREATE INDEX IF NOT EXISTS idx_subscribers_user_id_subscribed ON public.subscribers(user_id, subscribed);
